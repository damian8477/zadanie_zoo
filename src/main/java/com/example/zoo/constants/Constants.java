package com.example.zoo.constants;

public final class Constants {
    public static final String ZONE_NAME = "Strefa o takiej nazwie już istnieje";
    public static final String ZONE_ADD = "Strefa dodana";
    public static final String ZONE_ERROR = "Błąd podczas tworzenia strefy";
